...
[![npm downloads](https://img.shields.io/npm/dm/@protradeshare/ngx-datatable.svg)](https://npmjs.org/@protradeshare/ngx-datatable)
...
It was built for modern browsers using _TypeScript, CSS3 and HTML5_ and Angular `9.x.x`. This is the sister project of the [angular-data-table](https://github.com/swimlane/angular-data-table) that is designed for Angular 1.x.
...
To use ngx-datatable in your project install it via [npm](https://www.npmjs.com/package/@protradeshare/ngx-datatable):

```
npm i @protradeshare/ngx-datatable --save
```
